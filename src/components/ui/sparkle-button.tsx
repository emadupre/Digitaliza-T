...
export const SparkleButton = ({ text = "Comencemos", href = "/contacto" }: SparkleButtonProps) => {
  ...
  return (
    <div className="sparkle-button">
      <Link to={href}>
        <button className="group text-base sm:text-lg py-2 px-6 sm:px-8 rounded-full scale-90 hover:scale-100 transition-all duration-300">
          <span className="spark"></span>
          <span className="backdrop"></span>
          <svg className="sparkle size-4 sm:size-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
