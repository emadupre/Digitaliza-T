...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-black/95 to-black border-t border-purple-500/20 py-12 relative overflow-hidden">
      {/* Efectos de fondo - reducidos para mejorar el rendimiento */}
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-purple-600/20 rounded-full filter blur-[80px] opacity-30"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-600/20 rounded-full filter blur-[80px] opacity-20"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-8 max-w-md">
              Transformando el futuro digital de tu negocio con soluciones tecnológicas innovadoras y estrategias personalizadas.
            </p>
